...
public class RequestHandlerDeltaMonthly {
    public static String requestHandlerDeltaMonthly(String origin, String destination, String date, int numPassengers, boolean upperCabin) {
        ...
        String requestBody = String.format("""
            ...
            }""", passengersJson,cabin, date, destination, origin);
