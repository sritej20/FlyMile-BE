...
public class AmericanYearly {
    ...
    public static CompletableFuture<List<DailyCheapest>> getFlightDataListAmericanYearly(String origin, String destination, int numPassengers, boolean upperCabin) {
        ...
        List<CompletableFuture<List<DailyCheapest>>> futures = IntStream.range(0, 12)
                ...
                .map(date -> AmericanMonthly.getFlightDataListAmericanMonthly(origin, destination, date, numPassengers, upperCabin))
                .toList();
