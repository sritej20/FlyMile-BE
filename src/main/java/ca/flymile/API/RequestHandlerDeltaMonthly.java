...
public class RequestHandlerDeltaMonthly {
    public static String requestHandlerDeltaMonthly(String origin, String destination, String date, int numPassengers, String upperCabin) {
        ...
        String requestBody = String.format("""
            ...
            }""", passengersJson,upperCabin, date, destination, origin);
