...
public class RequestHandlerDelta {
    public static String requestHandlerDelta(String origin, String destination, String date, int numPassengers, String upperCabin) {
        ...
        String requestBody = String.format("""
                  ...
                  """, date, destination, origin, upperCabin, passengersJson);
